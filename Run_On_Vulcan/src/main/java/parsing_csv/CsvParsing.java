...
public class CsvParsing implements Serializable {
	...
	public Object getANY(int position) {
		...
		Object[] getMethods = { getName(), getTimeStampFromDate(), getBatt_Volt(), getTemp(), getpH(), getpHmv(), getCond(),
	 ...
	 */
	public int getName() {
		return Integer.parseInt(Name.substring(Name.length()-2,  Name.length()));
//		return Name;
	}
	 ...
	 * @return the time
	 */
	public java.sql.Timestamp getTimeStampFromDate() {
